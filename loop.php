...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'Skeleton') ) ) : ?>
...
<?php else : ?>			
				...
				?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'Skeleton' ),
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'Skeleton') ) ) : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
